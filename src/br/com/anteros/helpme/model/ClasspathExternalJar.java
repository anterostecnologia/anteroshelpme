...
public class ClasspathExternalJar extends Classpath {
	...
	public String[] getName() {
		return new String[] { PluginUtils.getNameFromFileName(classpath) + " - "
				+ PluginUtils.getPathFromFileName(classpath) };
	}
