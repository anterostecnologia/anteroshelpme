...
public class CustomDateTime extends Composite implements KeyListener, FocusListener {
	...
	public CustomDateTime(Composite parent, int style) {
		...
		this.setTabList(new Control[] { dateControl, timeControl });

		dateControl.addKeyListener(this);
		timeControl.addKeyListener(this);
	...
	public void setTimeControl(DateTime timeControl) {
	...
	public Date getDate() {
		 Date value = dateControl.getValue();
		 value.setHours(timeControl.getHours());
		 value.setMinutes(timeControl.getMinutes());
		 value.setSeconds(timeControl.getSeconds());
		 return value;
	}
	...
	public void setDate(Date date) {
		if (date == null) {
			...
			timeControl.setDate(0, 0, 0);
			timeControl.setTime(0, 0, 0);
		} else {
			dateControl.setValue(date);
			timeControl.setTime(date.getHours(), date.getMinutes(), date.getSeconds());
		}
	}
